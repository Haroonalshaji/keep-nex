...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Document digitization, onsite inventory teams, CMMS, cloud services, cyber security, and custom software development." },
      { property: "og:title", content: "Services — KeepNex IT" },
      { property: "og:description", content: "Six core IT services delivered by senior engineers." },
    ],
  }),
