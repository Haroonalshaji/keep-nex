...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "We're a senior-led IT services firm building the digital backbone of modern enterprises." },
      { property: "og:title", content: "About — KeepNex IT" },
      { property: "og:description", content: "Senior-led, vertically integrated IT services." },
    ],
  }),
  component: AboutPage,
});
...
const values = [
  ...
  { icon: Award, title: "Quietly excellent", body: "ISO 27001, SOC 2, and a 96% client retention rate." },
];
