...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Trusted IT partner for document digitization, onsite inventory, CMMS, cloud, cyber security & custom software development." },
      { property: "og:title", content: "KeepNex — Enterprise IT Services" },
      { property: "og:description", content: "Six core services. One trusted technology partner." },
    ],
  }),
  component: Home,
});
